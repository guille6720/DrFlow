...
- Proyecto Supabase con migraciones **001–032** aplicadas (ver [docs/MIGRATIONS.md](MIGRATIONS.md))
...
npm run migrate:p0       # 030–032 en prod (requiere DATABASE_URL)
npm run test:rls         # Auditoría RLS estática (+ integración opcional)
...
| "Falta migración" | Ver [docs/MIGRATIONS.md](MIGRATIONS.md) — `npm run migrate:p0` o SQL 030–032 |
| Perfil PAMI / coberturas | Migración **030** + botón en Configuración |
