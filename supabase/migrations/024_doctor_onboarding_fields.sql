-- Datos obligatorios del médico al crear consultorio + matrículas nacional/provincial.

ALTER TABLE profiles ADD COLUMN IF NOT EXISTS document_number TEXT;

ALTER TABLE professionals ADD COLUMN IF NOT EXISTS license_national TEXT;
ALTER TABLE professionals ADD COLUMN IF NOT EXISTS license_provincial TEXT;

DROP FUNCTION IF EXISTS setup_user_clinic(text, text, text);
