-- Fase 2D: telemedicina integrada (Jitsi embed + Daily.co opcional)
...
COMMENT ON COLUMN telemedicine_sessions.patient_join_url IS
  'URL pública DrFlow (/videoconsulta/:id) enviada al paciente.';
COMMENT ON COLUMN telemedicine_sessions.provider IS 'Proveedor de videollamada: jitsi (default) o daily.';
