-- Include insurance_plan in patient search RPC results (turnos picker + combobox).
-- Must DROP first: Postgres rejects CREATE OR REPLACE when OUT columns change.
...
CREATE OR REPLACE FUNCTION public.search_patients_for_clinic(  p_clinic_id UUID,
  p_query TEXT,
