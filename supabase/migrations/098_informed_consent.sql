-- Fase 3C: consentimiento informado digital vinculado a consulta clínica
...
COMMENT ON COLUMN consent_records.clinical_record_id IS 'Consulta clínica asociada (consentimiento informado por acto).';
COMMENT ON COLUMN consent_records.recorded_by IS 'Profesional o usuario que registró el consentimiento en sistema.';
COMMENT ON COLUMN consent_records.procedure_description IS 'Descripción del acto/procedimiento informado al paciente.';
COMMENT ON COLUMN consent_records.signature_name IS 'Nombre del paciente o representante que acredita el consentimiento.';
...
COMMENT ON FUNCTION public.record_informed_consent IS
  'Registra consentimiento informado digital vinculado a una consulta clínica (Ley 26.529).';
