-- Phase 6 — Electronic medical record integrity (Argentina compliance track)
-- Optimistic version counter + optional correction reason on immutable HC audit trail.
...
-- Recreate atomic update with record_version bump + change_reason
