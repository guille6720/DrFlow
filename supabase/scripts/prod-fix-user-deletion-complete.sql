-- PRODUCTION: fix completo para eliminar usuarios (cuenta propia + miembros del equipo).
-- Ejecutar en Supabase SQL Editor si fallan FKs de clinical_record_audit o appointment_status_history.
