...
/**
 * Fallback catalog when DB seed is unavailable (pre-migration or rollback).
 * Source of truth moves to `pami_planilla_*` tables after migration 079.
 */
export const pamiPlanillaFallbackCatalogEsAr: PamiPlanillaCatalog = {
  categories: [
    {
