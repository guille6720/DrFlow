...
export default function HomePage() {
  return (
    <div className="min-h-screen drflow-mesh">
      ...
      <section className="border-y border-blue-100/80 bg-white/60 py-16">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            {differentiators.map((f) => (
              <div
                key={f.title}
                className="rounded-2xl border border-blue-100/80 bg-white p-6 shadow-sm transition-shadow hover:shadow-md"
              >
                <div
      ...
      <section className="py-16">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 sm:grid-cols-3">
          {[
            ...
            { icon: Globe, title: "Reserva online", desc: "Link público para que reserven turno." },
          ].map((f) => (
            <div key={f.title} className="text-center">
              <f.icon className="mx-auto h-8 w-8 text-blue-600" />
