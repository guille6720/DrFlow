...
export function ClinicalOpsCenter({
  ...
  return (
    <section
      ...
      className="clinical-ops-center space-y-4 rounded-xl border border-[var(--border-default,#e2e8f0)] bg-[var(--surface-page,#f5f7f9)] p-4 text-[var(--text-primary,#0f172a)]"
    >
