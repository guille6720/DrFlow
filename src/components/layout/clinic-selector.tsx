...
export function ClinicSelector({ clinics, activeClinicId }: ClinicSelectorProps) {
  ...
  return (
    <select
      ...
      className="drflow-ui-input rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
    >
      {clinics.map((m) => (
