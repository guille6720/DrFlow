...
export function Header({
  ...
  return (
    <header className="border-b border-teal-100/80 bg-gradient-to-r from-white via-teal-50/20 to-white px-4 py-4 sm:px-6 lg:pl-72">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="rounded-xl border border-teal-100 bg-white px-4 py-2 text-right shadow-sm">
