...
import { patientEhrEvolutionBody } from "@/components/historias/patient-ehr-utils";
import type { PatientEhrAttachment, PatientEhrConsultation } from "@/lib/utils/patient-ehr-model";
