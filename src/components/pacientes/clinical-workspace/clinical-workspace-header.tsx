...
import { patientInitials } from "@/components/dashboard/clinical-ops-center/clinical-ops-shared";
...
import type { PatientChartAppointment, PatientChartProfessional } from "@/components/pacientes/patient-chart-types";
