...
import { ManualIllustration } from "@/components/manual/manual-illustration";
import { ExportManualPdfButton } from "@/components/manual/export-manual-pdf";
import { MANUAL_SECTIONS, MANUAL_SUBTITLE, MANUAL_TITLE } from "@/lib/manual/manual-data";
import { CHANGELOG, getAppVersion } from "@/lib/app-release";
