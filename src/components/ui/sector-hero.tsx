  ...
  return (
    <div className="mb-8 border-b border-slate-200/80 pb-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-5">
        <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-teal-600 text-white shadow-lg shadow-teal-500/25 sm:h-[4.5rem] sm:w-[4.5rem]">
